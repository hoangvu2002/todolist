...
function createTask(title, desc, due, priority, notes='', project='') {
    return {
        ...
        getIndex: () => {
            ...
            const index = _index__WEBPACK_IMPORTED_MODULE_0__.tasks.indexOf(this);
            return index;
        }
    }
};
