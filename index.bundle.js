...
/* harmony export */ });
function createTask(title, desc, due, priority, notes='') {
    return {
        title,
        desc,
        due,
...
console.log(today);
console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(today, 'yyyy-MM-dd'));

(0,_modal__WEBPACK_IMPORTED_MODULE_1__["default"])();

const task = (0,_create__WEBPACK_IMPORTED_MODULE_2__["default"])('sdf','asfes', new Date('2023-09-09'), 'urgent');
console.log(task);
