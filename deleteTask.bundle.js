...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,gCAAgC;IAChC,+DAA4D;IAC5D,gBAAgB;IAChB,kBAAkB;AACtB;;AAEA;IACI,UAAU;IACV,SAAS;IACT,sBAAsB;IACtB,gCAAgC;IAChC,eAAe;AACnB;;AAEA;IACI,gDAAgD;AACpD;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,mCAAmC;IACnC,8BAA8B;IAC9B,YAAY;AAChB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,WAAW;AACf;;AAEA;IACI,kBAAkB;IAClB,sBAAsB;IACtB,aAAa;IACb,wDAAwD;AAC5D;;AAEA;IACI,kBAAkB;IAClB,uBAAuB;IACvB,YAAY;AAChB;;AAEA;IACI,gCAAgC;IAChC,2BAA2B;AAC/B","sourcesContent":["@font-face {\n    font-family: 'Just Another Hand';\n    src: url('./JustAnotherHand-Regular.ttf') format('truetype'); \n    font-weight: 800;\n    font-style: normal; \n}\n\n* {\n    padding: 0;\n    margin: 0;\n    box-sizing: border-box;\n    font-family: 'Just Another Hand';\n    font-size: 30px;\n}\n\np {\n    font-family: Verdana, Geneva, Tahoma, sans-serif;\n}\n\nbody {\n    height: 100vh;\n}\n\n.content {\n    display: grid;\n    grid-template-rows: 100px 1fr 100px;\n    grid-template-columns: 1fr 4fr;\n    height: 100%;\n}\n\n.heading {\n    grid-column: 1 / 3;\n}\n\n.nav-bar {\n    grid-column: 1 / 2;\n    grid-row: 2;\n}\n\n.task-display {\n    grid-column: 2 / 3;\n    background-color: aqua;\n    display: grid;\n    grid-template-rows: repeat(auto-fit, minmax(200px, 1fr));;\n}\n\n.footer {\n    grid-column: 1 / 3;\n    background-color: black;\n    color: white;\n}\n\n.task-div > * {\n    font-family: 'Just Another Hand';\n    background-color: aliceblue;\n}"],"sourceRoot":""}]);
// Exports
